...
Customizable Blogily WordPress Theme, Copyright 2018 ThemeEverest
Customizable Blogily is distributed under the terms of the GNU GPL
All files coded by me, and fonts (for example Customizable Blogily font) is under GPLv2 http://www.gnu.org/licenses/gpl-2.0.html

Customizable Blogily bundles the following third-party resources:
...
All images were downloaded and used when Pexels and other websites provided 100% GPL images. Even though the websites have changed the licenses, the old GPL remains from the photos that were downloaded back then. All images are CC0/GPL compatible.
...
* Font: Customizable Blogily Fonts (customizable-blogily can be found in /fonts)
License: SIL OFL 1.1
License: CC0 License
